...
import com.example.ordersapp.order_feature.presentation.mapper.toBoughtProduct
import com.example.ordersapp.order_feature.presentation.mapper.toProductListItem
...
class OrderChooseProductsViewModel @Inject constructor(
    ...
    private val confirmOrderUseClass: ConfirmOrderUseClass
) : ViewModel() {
    ...
    var productsToShow = mutableListOf<ProductListItem>()
        private set
